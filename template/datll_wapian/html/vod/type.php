        ...
        <div class="b-listfilter" style="padding: 0px;">
          ...
          <dl class="b-listfilter-item js-listfilter" style="padding-left: 0px;height:auto;padding-right:0px;">
            <dd class="item g-clear js-listfilter-content" style="margin: 0;">
              ...
              <a href='{:mac_url_type($obj)}' class="menu-itema" target='_self'>全部</a> 
		
		{maccms:type parent="current"  by="sort"}
        <a href="{:mac_url_type($vo,[],'show')}" target='_self'>{$vo.type_name}</a>
		{/maccms:type}
        
                <a href='{:mac_url_type($obj,['area'=>$param['area'],'lang'=>$param['lang'],'year'=>$param['year'],'level'=>$param['level'],'letter'=>$param['letter'],'state'=>$param['state'],'tag'=>$param['tag'],'class'=>'','order'=>$param['order'],'by'=>$param['by'] ],'show')}' target='_self'>片库</a></dd>
          </dl>
        </div>
      </div>
      <div class="m-g">
