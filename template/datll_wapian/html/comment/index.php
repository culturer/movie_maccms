        ...
        <div class="cmt_wrap" >
            ...
            <div class="cmt_item clearfix">
                ...
                <div class="item_con fl">
                    ...
                    <p class="con">{$vo.comment_content}</p>
                    <div class="gw-action">
                        <span class="click-ding-gw">
                            <a class="comment_digg" data-id="{$vo.comment_id}" data-type="up" href="javascript:;">
                                <i class="icon-ding"></i>
                                <em class="comment_digg_num icon-num">{$vo.comment_up}</em>
                            </a>
                            <a class="comment_digg" data-id="{$vo.comment_id}" data-type="down" href="javascript:;">
                                <i class="icon-dw"></i>
                                <em class="comment_digg_num icon-num">{$vo.comment_down}</em>
                            </a>
                        </span>
                    ...
                    <div class="cmt_item clearfix">
                        ...
                        <div class="item_con fl">
                            ...
                            <p class="con">{$child.comment_content}</p>
                        </div>
                        <div class="gw-action">
                        <span class="click-ding-gw">
